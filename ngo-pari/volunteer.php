...
<body>
    ...
    <div class="page-nav no-margin row">
        <div class="container">
            <div class="row">
                <h2>Volunteer with Us in Spreading love</h2>
                <ul>
    ...
    <div class="">
        ...
        <form class="pt-4 col-md-5 m-auto" name="userForm" method="POST" action='volunteer.php'>
            ...
            <div class="form-label-group">
                ...
                <input type="checkbox" name="check_list[]" value="Food Distribution Drive"><label>&nbsp;&nbsp;1</label><br>
                <input type="checkbox" name="check_list[]" value="Covid Relief Camp"><label>&nbsp;&nbsp;Covid Relief Camp</label><br>
                <input type="checkbox" name="check_list[]" value="Old Age Home Visit"><label>&nbsp;&nbsp;3</label><br>
                <input type="checkbox" name="check_list[]" value="Orphange Visit"><label>&nbsp;&nbsp;4</label><br>
                <input type="checkbox" name="check_list[]" value="Mental Health Center Volunteering"><label>&nbsp;&nbsp;5</label><br>
                <b>Please Select One Option for Volunteering.</b>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-sm-12">
                    <h2>About Us</h2>
                    <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam, eligendi? Odio officia repellat libero praesentium magnam accusamus eius, suscipit mollitia ipsam nulla voluptatem nobis veniam dolores animi, fugit dolorem consectetur?
                    </p>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam odit, recusandae libero quisquam voluptatum commodi et ad, tempora excepturi in tenetur eius! Et ducimus necessitatibus earum laborum laboriosam nihil quod!</p>
                </div>
                <div class="col-md-4 col-sm-12">
                    <h2>Useful Links</h2>
                    <ul class="list-unstyled link-list">
                        <li><a ui-sref="about" href="#/about">About us</a><i class="fa fa-angle-right"></i></li>
                        <li><a ui-sref="portfolio" href="#/portfolio">link1</a><i class="fa fa-angle-right"></i></li>
                        <li><a ui-sref="products" href="#/products">Link 2</a><i class="fa fa-angle-right"></i></li>
                        <li><a ui-sref="gallery" href="#/gallery">link 3</a><i class="fa fa-angle-right"></i></li>
                        <li><a ui-sref="contact" href="#/contact">link 4</a><i class="fa fa-angle-right"></i></li>
                    </ul>
                </div>
                <div class="col-md-4 col-sm-12 map-img">
                    ...
                    <address class="md-margin-bottom-40">
                        loveFoundation <br>
                         <br>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Corrupti quam, numquam repudiandae animi mollitia quo recusandae fuga quibusdam perspiciatis ea nemo doloribus maiores beatae? Corporis est quasi inventore illum quo! <br>
                        *********** <br>
                        Email: <a href="mailto:parioundation@gmai.com" class="">parifoundation@gmai.com</a><br>
            ...
            <div class="nav-box row clearfix">
                <div class="inner col-md-9 clearfix">
                    <ul class="footer-nav clearfix">
                        ...
                        <li><a href="contact_us.php">6</a></li>
                    </ul>
